...
def update_experiment(experiment_id: int, **kwargs) -> None:
...
def create_result(experiment_id, datapoint_id, result) -> None:
...
def get_results_by_experiment(experiment_id) -> list:
