...
import dataland_qa_lab.dataland.get_data
...
def test_dummy_get_data() -> None:
    ...
    current_values = dataland_qa_lab.dataland.get_data.get_values_by_data(data=data)
    test = dataland_qa_lab.dataland.get_data.get_datasource_reference_bytes(data=data)
...
def test_dummy_data_extraction(mock_create: Any, mock_extract_text_of_pdf: Any) -> None:  # noqa: ANN401, ARG001
    ...
    dataland_qa_lab.dataland.get_data.get_values_by_data(data=dataset)
    data = dataland_qa_lab.dataland.get_data.get_datasource_reference_bytes(data=dataset)
