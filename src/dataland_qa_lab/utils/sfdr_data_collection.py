...
class SFDRDataCollection:
    ...
    def get_value(self, field_id: str) -> float | str | None:
        """Generic method to get a value based on the field ID."""
        datapoint = getattr(self.data.environmental.greenhouse_gas_emissions, field_id, None)
