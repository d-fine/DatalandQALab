...
from qa_lab.dataland.alerting import send_alert_message
from qa_lab.dataland.scheduled_processor import run_scheduled_processing
...
def test_send_alert_message() -> None:
    with (
        ...
        patch("dataland_qa_lab.dataland.alerting.config.get_config") as mocked_get_config,
    ):
